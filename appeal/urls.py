...
urlpatterns = [
	path('', appeal_list),#стартовая страница без функционала
    path('appeal_list/', appeal_list),#список всех обращений в таблице django_Appeal
    path('archive_appeal_list/', archive_appeal_list),#список всех обращений в таблице django_Appeal
    ...
    path('appeal_archive/<int:appeal_id>', appeal_archivate),
